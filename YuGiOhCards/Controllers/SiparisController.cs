...
namespace YuGiOhCards.Controllers
{
    public class SiparisController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,MusteriId,SiparisTarihi,GondermeTarihi,TeslimTarihi,IadeTarihi,KargoFirma,KargoUcret,ToplamUcret,Indirim,SiparisDurumu,OdemeDurumu,SiparisKodu,KargoTakipNo,Aciklama")] Siparis siparis)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MusteriId,SiparisTarihi,GondermeTarihi,TeslimTarihi,IadeTarihi,KargoFirma,KargoUcret,ToplamUcret,Indirim,SiparisDurumu,OdemeDurumu,SiparisKodu,KargoTakipNo,Aciklama")] Siparis siparis)
        {
            if (id != siparis.Id)
            {
                return NotFound();
